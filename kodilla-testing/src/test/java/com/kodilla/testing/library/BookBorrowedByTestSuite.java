...
public class BookBorrowedByTestSuite {
    ...
    public void testBookBorrowedByUserOneBook() {
        ...
        LibraryUser user1 = new LibraryUser("Marcin","Kowalski", "12345678909");
    ...
    @Test
    public void testBookBorrowedByUserWithoutBook() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);

        LibraryUser user1 = new LibraryUser("Marcin","Kowalski", "12345678909");
        List<Book> listWithoutBook = new ArrayList<Book>();

        when(libraryDatabaseMock.listBooksInHandsOf(user1)).thenReturn(listWithoutBook);
    ...
    public void testBookBorrowedByUserFiveBooks() {
        ...
        Book book3 = new Book("Secret life of programmers", "Steve Wolkowitz", 2016);
        Book book4 = new Book("Secrets of Java", "Ian Tenewitch", 2010);
        Book book5 = new Book("The Secret of Mokey Island", "Terry Prachett", 1990);

        LibraryUser user1 = new LibraryUser("Marcin","Kowalski", "12345678909");
        LibraryUser user2 = new LibraryUser("Marcin","Kowalski", "12345678909");
        LibraryUser user3 = new LibraryUser("Marcin","Kowalski", "12345678909");
